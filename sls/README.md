...
This project was generated using [Nx](https://nx.dev) with the following command.
...
Libraries are shareable across libraries and applications. They can be imported from `@sls/mylib`.
